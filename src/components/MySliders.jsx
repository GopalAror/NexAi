    ...
    return (
        <div className='relative z-[1] overflow-x-clip'>
            <div className="max-w-[912px] mx-auto px-3 sm:pt-[140px] pt-[70px] md:pt-[200px] pb-[45px] sm:pb-[90px]">
                <h2 className='text-[#02CDCF] ff-recharge font-bold leading-[25px] sm:leading-[50px] text-center sm:text-[35px] text-[30px] md:text-[40px]' data-aos="zoom-in-down">NexAi does all this. And more.</h2>
