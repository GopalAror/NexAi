...
const Header = () => {
    return (
        ...
        <div className="max-w-[1140px] px-3 mx-auto max-sm:pt-[50px] sm:grow w-full flex justify-center flex-col relative z-[2] overflow-x-clip">
            <h1 className='text-white ff-recharge leading-[35px] sm:leading-[50px] 2xl:leading-[75px] sm:text-[45px] text-[25px] 2xl:text-[60px] font-bold max-w-[577px]' data-aos="zoom-in"><span className='text-[#02CDCF]'>Nexai</span> is an advanced AI-powered home assistant</h1>
