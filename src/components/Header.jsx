...
const Header = () => {
    return (
        ...
        <div className="2xl:max-w-[1140px] xl:max-w-[1050px] max-w-[990px] px-3 lg:ml-[100px] xl:ml-[150px] max-sm:pt-[50px] grow w-full flex justify-center flex-col relative z-[2] overflow-x-clip">
            <h1 className='text-white ff-recharge leading-[35px] 2xl:pt-10 sm:leading-[55px] 2xl:leading-[75px] sm:text-[40px] text-[25px] xl:text-[60px] font-bold max-w-[577px]' data-aos="zoom-in"><span className='text-[#02CDCF]'>Nexai</span> is an advanced AI-powered home assistant</h1>
