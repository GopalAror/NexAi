...
const Header = () => {
    return (
        ...
        <div className="2xl:max-w-[1140px] max-lg:mt-[-100px] 2xl:mt-[-45px] xl:max-w-[1050px] max-w-[990px] px-3 lg:ml-[100px] xl:ml-[130px] max-sm:pt-[50px] grow w-full flex justify-center flex-col relative z-[2] overflow-x-clip">
            <h1 className='text-white ff-recharge leading-[35px] sm:leading-[55px] xl:leading-[50px] 2xl:leading-[75px] max-xl:text-[40px] md:mt-10 xl:mt-0 text-[35px] max-2xl:!text-[45px] 2xl:text-[60px] font-bold max-w-[577px]' data-aos="zoom-in"><span className='text-[#02CDCF]'>Nexai</span> is an advanced AI-powered home assistant</h1>
