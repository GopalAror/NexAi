...
const Header = () => {
    return (
        ...
        <div className="max-w-[1140px] px-3 mx-auto grow w-full flex justify-center flex-col relative z-[2]">
            ...
            <p className='opacity-70 pb-[15px] sm:pb-[51px] text-white font-poppins font-normal leading-[25px] text-[14px] sm:text-[16px] pt-2 sm:pt-4'>Etiam viverra nec libero a. A id id tempus molestie sed. Fringilla odio.</p>
