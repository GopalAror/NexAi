            ...
            <div className="max-w-[1240px] mx-auto px-3" id="token">
                ...
                <div className="flex flex-row flex-wrap justify-between -mx-3">
                    <div className="md:w-6/12 w-full flex items-center justify-center md:max-w-[571px] px-3">
                        <img className='w-full relative z-0' src={hand} alt="hand" />
                    </div>
                    <div className="md:w-6/12  w-full sm:max-w-[670px] px-3 h-[430px] flex justify-end scroll overflow-y-scroll mt-[63px]">
                        <ol class="relative  after:absolute after:w-[10px] after:sm:min-h-[1430px] after:max-[550px]:min-h-[1430px] after:min-h-[1150px] after:min after:top-0 after:bottom-0 after:left-[-1.5%] after:sm:left-[-8%] overflow-visible after:rounded-[15px] after:z-[1] after:bg-[#02CDCF]">
                            <li class="mb-14 ms-4">
                                <div class="absolute w-6 h-6 z-[2] bg-[#FCFCFC] rounded-full mt-[90px] sm:left-[-9.2%] -start-[13px] border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                <time class="mb-4 text-white ff-recharge font-bold text-[16px] sm:text-[24px] leading-[31px]">Purchasing Nexai Products</time>
                            ...
                            <li class="mb-14 ms-4">
                                <div class="absolute w-6 h-6 z-[2] bg-[#FCFCFC] rounded-full mt-[90px]  sm:left-[-9.2%] -start-[13px] border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                <time class="mb-4 text-white ff-recharge font-bold text-[16px] sm:text-[24px] leading-[31px]">Accessing Exclusive Content</time>
                            ...
                            <li class="mb-14 ms-4">
                                <div class="absolute w-6 h-6 z-[2] bg-[#FCFCFC] rounded-full mt-[90px]  sm:left-[-9.2%] -start-[13px] border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                <time class="mb-4 text-white ff-recharge font-bold text-[16px] sm:text-[24px] leading-[31px]">Loyalty and Rewards</time>
                            ...
                            <li class="mb-14 ms-4">
                                <div class="absolute w-6 h-6 z-[2] bg-[#FCFCFC] rounded-full mt-[90px]  sm:left-[-9.2%] -start-[13px] border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                <time class="mb-4 text-white ff-recharge font-bold text-[16px] sm:text-[24px] leading-[31px]">Participating in Governance</time>
                            ...
                            <li class="mb-14 ms-4">
                                <div class="absolute w-6 h-6 z-[2] bg-[#FCFCFC] rounded-full mt-[90px]  sm:left-[-9.2%] -start-[13px] border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                <time class="mb-4 text-white ff-recharge font-bold text-[16px] sm:text-[24px] leading-[31px]">Peer-to-Peer Transactions</time>
                            ...
                            <li class="mb-14 ms-4">
                                <div class="absolute w-6 h-6 z-[2] bg-[#FCFCFC] rounded-full mt-[90px]  sm:left-[-9.2%] -start-[13px] border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                                <time class="mb-4 text-white ff-recharge font-bold text-[16px] sm:text-[24px] leading-[31px]">Token Staking and Rewards</time>
