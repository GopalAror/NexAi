        ...
        <div className='relative overflow-x-clip'>
            ...
            <div className="max-w-[1180px] relative z-[1] md:pb-[72px] md:pt-[130px] px-3 mx-auto" id="home">
                <div className="flex flex-row flex-wrap -mx-3">
                    ...
                    <div className="md:w-6/12 w-full max-md:pt-8 pl-3 md:pl-[44px] max-w-[517px] flex flex-col justify-end">
                        <h2 className='sm:pb-4 pb-2 text-[#02CDCF] ff-recharge font-bold text-[30px] sm:text-[35px] md:text-[40px] sm:leading-[40px] leading-[27px] md:leading-[50px]' data-aos="fade-left">Ai-Powered Home Assistant</h2>
