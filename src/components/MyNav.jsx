        ...
        <div className="max-w-[1140px] mx-auto px-3">
          <div className="flex justify-between items-center w-full h-[80px] sm:h-[100px]">
            ...
            <ul className={`flex items-center gap-5 max-md:flex-col max-md:justify-center max-md:w-full max-md:h-full max-md:fixed max-md:top-0 z-[5] max-md:bg-[#040404] duration-700 ${navbar ? "right-0" : "right-[-100%]"}`}>
              ...
              <li><a className='font-poppins font-normal text-[16px] leading-[24px] text-white relative after:absolute after:hover:w-full after:w-0 after:h-[2px] after:left-0 after:duration-500 after:bottom-[-2%] after:rounded-2xl after:bg-[#02CDCF]' onClick={view} href="#market">Marketplace</a></li>
